...
const promises = loadStripe(process.env.REACT_APP_STRIPE_PUB)
const CheckoutForm = () => {
  const cardStyle = {
    style: {
      base: {
    ...
    <div>
      {succeed ? (
        ...
        <article>
          ...
          <p>Test your card Number : 4242 4242 4242 4242 </p>
        </article>
      )}
      <form onSubmit={handleSubmit} id='payment-form'>
        ...
        />
        <button disabled={processing || disable || succeed} id='submit'>
          <span id='button-text'>
